...
분석: "현재 상황: [현재 상태 설명]"
이유: "이유: [이 변경이 필요한 이유 설명]"
계획: "계획: [구체적인 변경사항 상세]"
실행: "실행: [변경사항 수행]"
검증: "검증: [변경이 성공했음을 확인]"
문서화: "문서 업데이트: [PRD 기반 README.md 생성, CLAUDE.md 간단 업데이트]"
📋 구체적인 지침
항상 제거해야 할 파일들:
...
PRD 정보 추출 규칙
프로젝트명: PRD 제목에서 추출
핵심 설명: PRD 핵심 정보 > 목적에서 추출
페이지 구조: PRD 페이지 구조 섹션에서 추출
주요 기능: PRD UI 구성 요소에서 추출
기술 스택: package.json과 PRD 기술 스택 섹션 결합
